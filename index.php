  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
    <div class="container">
      <a class="navbar-brand fw-bold text-success" href="#">
        <i class="bi bi-box-seam-fill me-1"></i> Aplikasi Antrian
      </a>
      <div class="ms-auto">
        <?php if (isset($_SESSION['admin'])): ?>
          <a href="logout.php" class="btn btn-outline-danger">Logout</a>
        <?php else: ?>
          <a href="login.php" class="btn btn-outline-success">Login Admin</a>
        <?php endif; ?>
      </div>
    </div>
  </nav>
      ...
      <div class="col-md-5 col-lg-4 mb-4">
        <div class="card text-center service-card border-0 shadow-sm">
          <div class="card-body p-4">
            ...
            <a href="nomor-antrian/ambil.php?jenis=pencarian" class="btn btn-primary w-100">
              Ambil Nomor
            </a>
          </div>
        </div>
